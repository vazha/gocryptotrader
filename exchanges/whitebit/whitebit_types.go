...
// AccountFees stores withdrawal account fee data from Whitebit
...
// MarginInfo holds metadata for margin information from Whitebit
...
type Balance struct {
	...
	MainBalance float64 `json:"main_balance,string"`
}
...
// ErrorCapture is a simple type for returned errors from Whitebit
