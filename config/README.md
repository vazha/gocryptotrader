...
[![GoDoc](https://godoc.org/github.com/vazha/gocryptotrader?status.svg)](https://godoc.org/github.com/vazha/gocryptotrader/config)
...
```sh
cd ~/go/src/github.com/vazha/gocryptotrader
